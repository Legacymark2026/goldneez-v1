...
import { ArrowLeft, Check, ChevronRight, FileText, Globe, Mail, Phone, Shield, Cookie, Settings, AlertTriangle } from "lucide-react";
    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-slate-950 font-sans selection:bg-blue-100 selection:text-blue-900">
            ...
            <div className="relative bg-white dark:bg-slate-900 border-b border-gray-100 dark:border-slate-800 overflow-hidden">
                ...
                <div className="relative mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:px-8">
                    <nav className="flex items-center space-x-2 text-sm text-gray-500 mb-8">
                        ...
                        <ChevronRight className="w-4 h-4" />
                        <span className="text-gray-900 dark:text-slate-100 font-medium">Política de Cookies</span>
                    </nav>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
                    <div className="hidden lg:block lg:col-span-1">
                        <div className="sticky top-24 space-y-1">
                            <h3 className="text-sm font-semibold text-gray-900 dark:text-white uppercase tracking-wider mb-4 pl-3">
                                Contenido
                            </h3>
                                    ...
                                    <button
                                        ...
                                        className={cn(
                                            ...
                                            activeSection === section.id
                                                ? "bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 shadow-sm translate-x-1"
                    ...
                    <div className="lg:col-span-3 space-y-12">
                        ...
                        <SectionCard id="types" title="2. Tipos de Cookies que Utilizamos" icon={<Settings className="w-6 h-6 text-purple-600" />}>
                            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-4">2.1. Según la entidad</h3>
                            ...
                            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">2.2. Según su finalidad</h3>
                            ...
                            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-8 mb-4">2.3. Según plazo</h3>
                        ...
                        <SectionCard id="legal-basis" title="3. Base Legal" icon={<Shield className="w-6 h-6 text-green-600" />}>
                            <p className="text-gray-600 dark:text-gray-400 mb-4">El tratamiento se basa en tu consentimiento expreso e informado (Ley 1581 de 2012).</p>
                            ...
                            <div className="overflow-x-auto">
                                <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                    <thead className="bg-gray-50 dark:bg-gray-800">
                                        <tr>
                                            <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Cookie</th>
                        ...
                        <SectionCard id="management" title="6. Gestión y Configuración" icon={<Settings className="w-6 h-6 text-slate-600" />}>
                            <p className="text-gray-600 dark:text-gray-400 mb-6">Puedes aceptar, bloquear o eliminar cookies en cualquier momento.</p>
                            <h3 className="font-semibold text-gray-900 dark:text-white mb-2">6.1. A través de nuestro aviso</h3>
                            ...
                            <h3 className="font-semibold text-gray-900 dark:text-white mb-2">6.2. A través del navegador</h3>
            ...
            <Button
                variant="outline"
                size="icon"
                className="fixed bottom-8 right-8 rounded-full shadow-lg bg-white dark:bg-slate-900 z-40 hidden md:flex"
