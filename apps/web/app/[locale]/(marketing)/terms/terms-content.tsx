    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-slate-950 font-sans selection:bg-blue-100 selection:text-blue-900">
            ...
            <div className="relative bg-white dark:bg-slate-900 border-b border-gray-100 dark:border-slate-800 overflow-hidden">
                ...
                <div className="relative mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:px-8">
                    <nav className="flex items-center space-x-2 text-sm text-gray-500 mb-8">
                        ...
                        <ChevronRight className="w-4 h-4" />
                        <span className="text-gray-900 dark:text-slate-100 font-medium">Términos y Condiciones</span>
                    </nav>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
                                    ...
                                    <button
                                        ...
                                        className={cn(
                                            ...
                                            activeSection === section.id
                                                ? "bg-indigo-50 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-300 shadow-sm translate-x-1"
                    ...
                    <div className="lg:col-span-3 space-y-12">
                        ...
                        <SectionCard id="ip" title="3. Propiedad Intelectual" icon={<Scale className="w-6 h-6 text-purple-600" />}>
                            <h3 className="font-semibold text-gray-900 dark:text-white mb-2">3.1. Derechos de la Agencia</h3>
                            ...
                            <h3 className="font-semibold text-gray-900 dark:text-white mb-2">3.2. Entregables al Cliente</h3>
                            <p className="text-gray-600 dark:text-gray-400 mb-4">
                        ...
                        <SectionCard id="obligations" title="5. Obligaciones del Usuario" icon={<Info className="w-6 h-6 text-cyan-600" />}>
                            <p className="text-gray-600 dark:text-gray-400 mb-4">El Usuario se compromete a:</p>
                            <ul className="space-y-3">
            ...
            <Button
                variant="outline"
                size="icon"
                className="fixed bottom-8 right-8 rounded-full shadow-lg bg-white dark:bg-slate-900 z-40 hidden md:flex hover:bg-gray-100 dark:hover:bg-slate-800"
