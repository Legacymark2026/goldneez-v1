        ...
        <section className="bg-transparent py-32 text-white relative overflow-hidden">
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 relative z-10">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-20 items-stretch">
                    {/* 3. Steps Navigation (Timeline) - Sticky Side */}
                        ...
                        <div className="flex flex-col gap-0">
                            {STEPS.map((step, index) => (
                                <div
                                    ...
                                    className={cn(
                                        "group relative flex items-center gap-6 p-4 rounded-sm cursor-pointer transition-all duration-300 border min-h-[100px]",
                                        activeStep === index
                                ...
                                >
                                    {/* ID Circle */}
                                    <div className={cn(
                                        "relative h-14 w-14 rounded-full flex items-center justify-center font-mono font-bold text-xl border transition-all duration-300 z-10 shrink-0",
                                        activeStep === index
                                            ? "bg-teal-500 text-slate-950 border-teal-400 scale-110 shadow-[0_0_15px_rgba(20,184,166,0.5)]"
                                            : "bg-slate-900 text-slate-400 border-slate-800 group-hover:border-slate-700 group-hover:text-slate-400 shadow-sm"
                                    )}>
                                        {step.id}
                                    </div>
                                    ...
                                    <div className="flex-1">
                                        <div className="flex justify-between items-center mb-2">
                                            <h3 className={cn(
                                                ...
                                                activeStep === index ? "text-white" : "text-slate-400 group-hover:text-slate-400"
                                            )}>
                                                {step.title}
                                            </h3>
