                                ...
                                <div className="relative bg-slate-900/50 backdrop-blur-sm border border-slate-800 rounded-sm p-4 overflow-hidden hover:border-teal-500/30 hover:shadow-[0_20px_50px_-12px_rgba(13,148,136,0.15)] hover:-translate-y-2 transition-all duration-500">
                                    ...
                                    <div className="px-2 pb-2">
                                        ...
                                        <div className="flex gap-2 pt-6 border-t border-slate-800">
                                            ...
                                            <button aria-label="Ver perfil de LinkedIn" className="p-2 rounded-sm hover:bg-slate-800 text-slate-400 hover:text-teal-400 transition-colors"><Linkedin size={16} strokeWidth={1.5} /></button>
                                            <button aria-label="Ver perfil de GitHub" className="p-2 rounded-sm hover:bg-slate-800 text-slate-400 hover:text-teal-400 transition-colors"><Github size={16} strokeWidth={1.5} /></button>
                                            <button aria-label="Enviar email" className="p-2 rounded-sm hover:bg-slate-800 text-slate-400 hover:text-teal-400 transition-colors ml-auto"><Mail size={16} strokeWidth={1.5} /></button>
                                        </div>
                                    </div>
                                </div>
                            </motion.div>
